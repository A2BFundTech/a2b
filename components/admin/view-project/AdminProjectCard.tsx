...
//                     <CardTitle className="text-sm leading-tight wrap-break-word flex-row ">
//                         <div>{project.translations[locale].name}</div>
//                         <div className="text-[#968c81] text-xs line-clamp-2 mt-0.5 flex gap-2 w-full">
//                             <Button
//                                 variant={"outline"}
//                                 size={"icon"}
//                                 onClick={handleOpen}
